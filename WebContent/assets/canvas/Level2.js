...
Level2.prototype.create = function () {
	...
	_bottomLayer_layer.position.setTo(-1280.0, 0.0);
	...
	_BlockLayer_layer.position.setTo(-1280.0, 0.0);
	...
	_MidLayer_layer.position.setTo(-1280.0, 0.0);
	_MidLayer_layer.resizeWorld();
	
	var _player = this.add.sprite(64.0, 96.0, 'atlas', 'misa-front-walk.000');

...
/** @type Phaser.State */
var Level03_proto = Object.create(Phaser.State.prototype);
Level03.prototype = Level03_proto;
Level03.prototype.constructor = Level03;

Level03.prototype.init = function () {
	
};

Level03.prototype.preload = function () {
...
Level03.prototype.create = function () {
	...
	_bottomLayer_layer.position.setTo(0.0, -1.0);
	...
	_BlockLayer_layer.position.setTo(0.0, -1.0);
	...
	_MidLayer_layer.position.setTo(0.0, -1.0);
	_MidLayer_layer.resizeWorld();
	
	var _player = this.add.sprite(3968.0, 224.0, 'atlas', 'misa-front-walk.000');
	...
	var _keyYellow = this.add.sprite(4032.0, 192.0, 'keyYellow');
	_keyYellow.scale.setTo(0.45714285714285713, 0.45714285714285713);
	this.game.physics.arcade.enable(_keyYellow);
	
	var _treasure_chest = this.add.sprite(4384.0, 704.0, 'treasure chest1', 0);
	...
	this.camera.setPosition(3840,0);
...
Level03.prototype.update = function () {
	...
	this.fTreasure_chest.x = 4384.0;
	this.fTreasure_chest.y = 704.0;
	this.physics.arcade.collide(this.fPlayer,this.fBlockLayer_layer);

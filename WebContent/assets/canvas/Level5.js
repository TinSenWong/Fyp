...
Level5.prototype.create = function () {
	...
	var _treasure_chest = this.add.sprite(416.0, 256.0, 'treasure chest1', 0);
	...
	var _base_out_atlas = this.add.sprite(448.0, 320.0, 'base_out_atlas', 234);
	this.game.physics.arcade.enable(_base_out_atlas);
	_base_out_atlas.body.immovable = true;
	...
	var _base_out_atlas = this.add.sprite(448.0, 384.0, 'base_out_atlas', 234);
	this.game.physics.arcade.enable(_base_out_atlas);
	_base_out_atlas.body.immovable = true;

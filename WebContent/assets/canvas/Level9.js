...
Level9.prototype.create = function () {
	...
	var _keyYellow = this.add.sprite(384.0, 352.0, 'keyYellow');
	_keyYellow.scale.setTo(0.45714285714285713, 0.45714285714285713);
	this.game.physics.arcade.enable(_keyYellow);
	
	var _treasure_chest = this.add.sprite(416.0, 352.0, 'treasure chest1', 0);
	...
	var _monster = this.add.sprite(352.0, 352.0, 'monster', 'sprite1', _block);

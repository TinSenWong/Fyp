...
if (isset($_POST['submit'])) {
    ...
    if (count($errors) == 0) {
        ...
        $result = mysqli_query($conn, "select * from userinfo where email = '$signup_email' and verified = 1") or die ();
        if (mysqli_num_rows($result) > 0) {
            array_push($errors, 'Account already exist.</p>');
        } else {
...
<head>
    ...
    <title>Login VIP - Bootsnipp.com</title>
